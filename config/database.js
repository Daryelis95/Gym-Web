  ...
  */
  mysql: {
    ...
    connection: {
      ...
      database: Env.get('DB_DATABASE', 'gymvirtual')
    }
  },
  ...
  */
  mongodb: {
    ...
    connection: {
      ...
      username: Env.get('DB_USER', 'gimweb'),
      password: Env.get('DB_PASSWORD', '01f7a83d246a60961f62d596e4bc51ac'),
      database: Env.get('DB_DATABASE', 'gimweb'),
      options: {
        /*
