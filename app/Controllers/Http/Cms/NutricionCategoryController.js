...
class NutricionCategoryController {
    ...
    async index({ request, auth, view, params }) {
        ...
        if(params.id) {
            ...
            if(!params.method || params.method == 'edit') {
                ...
                edit = await NutricionCategory.find(params.id)
            }
        }
        ...
        let contents = await NutricionCategory
            .query()
            .where(query)
            .paginate(page)

        return view.render('cms.pages.nutricion-categories.index', {
    ...
    */
    ...
    async add(request) {
        ...
        let content = new NutricionCategory(body);
        return content.save()
    }
    ...
    */
    ...
    async update(request) {
        ...
        let update  = await NutricionCategory.find(request.input('id'))
        let body    = request.only([
            'title',
            'description',
            'icon',
    ...
    */
    ...
    async remove(params) {
        ...
        let content = await NutricionCategory.find(params.id)
...
module.exports = NutricionCategoryController
