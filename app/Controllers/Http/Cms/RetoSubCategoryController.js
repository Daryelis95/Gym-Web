...
const RetoSubCategory   = use('App/Models/Cms/RetoSubCategory')
const Helpers           = use('Helpers')
const Logger            = use('Logger')

class RetoSubCategoryController {
    ...
    async index({ request, auth, view, params }) {
        ...
        if(params.id) {
            ...
            if(!params.method || params.method == 'edit') {
                ...
                edit = await RetoSubCategory.find(params.id)
            }
        }
        ...
        let contents = await RetoSubCategory
            .query()
            .where(query)
            .paginate(page)

        return view.render('cms.pages.reto-subcategories.index', {
    ...
    */
    ...
    async add(request) {
        ...
        let content = new RetoSubCategory(body);
        return content.save()
    }
    ...
    */
    ...
    async update(request) {
        ...
        let update = await RetoSubCategory.find(request.input('id'))
        let body = request.only([
            'title',
            'description',
            'icon',
    ...
    */
    ...
    async remove(params) {
        ...
        let content = await RetoSubCategory.find(params.id)
...
module.exports = RetoSubCategoryController
