...
class RetoCategoryController {
    ...
    async index({ request, auth, view, params }) {
        ...
        if(params.id) {
            ...
            if(!params.method || params.method == 'edit') {
                ...
                edit = await RetoCategory.find(params.id)
            }
        }
        ...
        let contents = await RetoCategory
            .query()
            .where(query)
            .with('subcategories')
            .paginate(page)

        return view.render('cms.pages.reto-categories.index', {
    ...
    */
    ...
    async add(request) {
        ...
        let content = new RetoCategory(body);
        return content.save()
    }
    ...
    */
    ...
    async update(request) {
        ...
        let update  = await RetoCategory.find(request.input('id'))
        let body = request.only([
            'title',
            'description',
            'icon',
    ...
    */
    ...
    async remove(params) {
        ...
        let content = await RetoCategory.find(params.id)
...
module.exports = RetoCategoryController
