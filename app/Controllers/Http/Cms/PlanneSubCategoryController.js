...
const PlanneSubCategory = use('App/Models/Cms/PlanneSubCategory')
const Helpers           = use('Helpers')
const Logger            = use('Logger')

class PlanneSubCategoryController {
    ...
    async index({ request, auth, view, params }) {
        ...
        if(params.id) {
            ...
            if(!params.method || params.method == 'edit') {
                ...
                edit = await PlanneSubCategory.find(params.id)
            }
        }
        ...
        let contents = await PlanneSubCategory
            .query()
            .where(query)
            .paginate(page)

        return view.render('cms.pages.planne-subcategories.index', {
    ...
    */
    ...
    async add(request) {
        ...
        let content = new PlanneSubCategory(body);
        return content.save()
    }
    ...
    */
    ...
    async update(request) {
        ...
        let update  = await PlanneSubCategory.find(request.input('id'))
        let body = request.only([
            'title',
            'description',
            'icon',
    ...
    */
    ...
    async remove(params) {
        ...
        let content = await PlanneSubCategory.find(params.id)
...
module.exports = PlanneSubCategoryController
